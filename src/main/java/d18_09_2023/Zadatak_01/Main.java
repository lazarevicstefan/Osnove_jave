...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        VideoPlayer videoPlayer = new VideoPlayer(138,31,10,720);
        videoPlayer.stampaj();
        System.out.println();

        TimeControl timeControl = new TimeControl(true);
        timeControl.izvrsiAkciju(videoPlayer); // Premotano u desno za 15s
        videoPlayer.stampaj();
        System.out.println();

        AudioControl audioControl = new AudioControl(true);
        audioControl.izvrsiAkciju(videoPlayer); // Pojacano za 1
        videoPlayer.stampaj();
        System.out.println();

        QualityOptimizerControl qualityOptimizerControl = new QualityOptimizerControl(34.2);
        qualityOptimizerControl.izvrsiAkciju(videoPlayer); // promenjen je kvalitet videa na osnovu prosledjene brzine
        videoPlayer.stampaj();
    }
}
